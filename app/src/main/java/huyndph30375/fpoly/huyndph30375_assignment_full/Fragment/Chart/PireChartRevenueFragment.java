...
import huyndph30375.fpoly.huyndph30375_assignment_full.databinding.FragmentPireChartRevenueBinding;


public class PireChartRevenueFragment extends Fragment {
    private FragmentPireChartRevenueBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPireChartRevenueBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvNgayKetThuc.setOnClickListener(v -> {
            ...
            materialDatePicker.addOnPositiveButtonClickListener(selection -> {
                ...
                ArrayList<RevenueInforModels> list = getData(binding.tvNgayBatDau.getText().toString(), binding.tvNgayKetThuc.getText().toString());

                HashMap<String, Float> moneyByCategory = new HashMap<>();
                for (RevenueInforModels item : list) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    RevenueInforModels item = list.get(i);
                    String moneyString = item.getMoney().replace(",", ".");
                    float money = Float.parseFloat(moneyString);
    ...
    public ArrayList<RevenueInforModels> getData(String ngaybatdau, String ngayketthuc){
        ArrayList<RevenueInforModels> list = new ArrayList<>();
        Cursor cursor = revenueSQLiteHelper.getData("SELECT * FROM REVENUEMENT WHERE date BETWEEN '"+ngaybatdau+"' AND '"+ngayketthuc+"'");
        double totalPay = 0.0;
        while (cursor.moveToNext()){
            ...
            list.add(new RevenueInforModels(id,date,note,money,idCategory,total));
